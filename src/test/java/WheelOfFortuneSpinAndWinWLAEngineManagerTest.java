...
public class WheelOfFortuneSpinAndWinWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(WheelOfFortuneSpinAndWinWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/WheelOfFortuneSpinAndWinWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/WheelOfFortuneSpinAndWinWLAIW/InitOutcome.xml").getDocumentElement();
